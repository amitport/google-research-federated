...
from drive.drive_utils import _create_drive_fn
...
def build_fed_avg_process(
  ...
  client_compress_roundtrip_fn = create_compress_roundtrip_fn(model_weights_type.trainable)
  ...
  def run_one_round(server_state, federated_dataset):
    ...
    weights_delta = tff.federated_map(
      client_compress_roundtrip_fn,
      client_outputs.weights_delta)

    model_delta = tff.federated_mean(
        weights_delta, weight=client_weight)
